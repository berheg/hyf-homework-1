class StudentBook {
    ...
    // method that returns all students list
    getAllStudents() {
    ...
    // method that returns students of a class
    ...
    // method that returns detailed info of 1 particular student
    ...
    // method that adds new student to the list
    ...
    // method that updates info of student
    ...
    deleteStudent(name) {
        const selectedStudentIndex = this.studentList.findIndex ((student) => {
            return student.name.toLowerCase() === name.toLowerCase();
        });
        if (selectedStudentIndex !== -1) {
            this.studentList.splice(selectedStudentIndex, 1);
